    ...
    <MotionSection id="depoimentos" className="bg-ink py-24 sm:py-32">
      <div className="section-container">
        <div className="mb-12 max-w-2xl">
          <h2
            className="font-sans font-extrabold tracking-[-0.03em] text-white"
        ...
        <div className="mt-12 flex flex-wrap items-end gap-8 border-t border-white/10 pt-10">
          <div>
            <p className="font-sans text-5xl font-extrabold tracking-tight text-white">
              5,0
            </p>
            <div className="mt-2 flex items-center gap-2">
              <Stars className="text-sm text-gold" />
              <span className="text-sm text-white/45">39 avaliações no Google</span>
            </div>
          </div>
          <ReviewAvatars />
        </div>
